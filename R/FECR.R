...
FECR<- function(T1=NULL,T2=NULL,C1=NULL,C2=NULL,method=c("Kochapakdee","Dash","Coles","Cabaret1","Cabaret2")){
  ...
  switch(method,
         ...
         "Cabaret1" = {
           ...
           if(any(length(T1)==1,length(T2)==1)){
             stop("a single value of epg has been provided in place of a vector of individual values.")
           }
