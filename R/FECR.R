...
FECR <- function(T1 = NULL,T2 = NULL,C1 = NULL,C2 = NULL,
  ...
  switch(method,
         ...
         "Cabaret1" = FECR_Cabaret1(T1,T2,compute.CI = compute.CI,percentile = percentile,boot = boot),
         "Cabaret2" = FECR_Cabaret2(T1,T2,C1,C2,compute.CI = compute.CI,percentile = percentile,boot = boot),
         "MacIntosh" = FECR_MacIntosh_Keuk(T1,T2,C1,C2,compute.CI = compute.CI,percentile = percentile,boot = boot)
  )
}
